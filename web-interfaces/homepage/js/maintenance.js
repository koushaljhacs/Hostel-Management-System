// File: web-interfaces/maintenance/js/maintenance.js
...
class MaintenanceManager {
    constructor() {
        this.checkInterval = 60000; // FIX: Check every 60 seconds (1 minute)
    ...
    startCountdown() {
        const updateCountdown = () => {
            ...
            let startHour = 22; // Default
            if (this.maintenanceStatus?.maintenanceWindow.startTime) {
                startHour = parseInt(this.maintenanceStatus.maintenanceWindow.startTime.split(':')[0]);
            }
...
function handleOkClick() {
    // FIX: Redirect to the homepage (/) for consistency with the automatic flow.
